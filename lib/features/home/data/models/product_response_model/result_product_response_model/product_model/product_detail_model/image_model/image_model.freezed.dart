...
abstract class $ImageModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String url, int priority, String? label});
}
...
class _$ImageModelImpl implements _ImageModel {
  const _$ImageModelImpl(
      {required this.url, required this.priority, this.label});
  ...
  @override
  String toString() {
    return 'ImageModel(url: $url, priority: $priority, label: $label)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, url, priority, label);
...
abstract class _ImageModel implements ImageModel {
  const factory _ImageModel(
      ...
      final String? label}) = _$ImageModelImpl;
